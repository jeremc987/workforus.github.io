...
function new_game(){
 ...
 var my_players=[
  new player("Augustin Delahodde",0,"","","",0,0),
  new player("Michael Cilpa",0,"","","",0,0),
  new player("Robin Debrabant",0,"","","",0,0),
  new player("Clement Bompard",0,"","","",0,0)
 ];
 players=new Array(my_players.length+1);
 var player_name=getCookie("playername");
 if(!player_name)player_name="Bo";
...
function preload_base_pix(){preload_sd.src="d.gif";preload_sh.src="h.gif";preload_sc.src="c.gif";preload_ss.src="s.gif";preload_cb.src="cardback1.jpg";}
